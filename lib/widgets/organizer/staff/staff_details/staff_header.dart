...
class StaffHeaderWidget extends StatefulWidget {
  final Staff staff;

  const StaffHeaderWidget({super.key, required this.staff});

  @override
  State<StaffHeaderWidget> createState() => _StaffHeaderWidgetState();
}

class _StaffHeaderWidgetState extends State<StaffHeaderWidget> {
