...
class AttendeeSidebar extends StatelessWidget {
  final String currentRoute;

  const AttendeeSidebar({super.key, required this.currentRoute});
                    ...
                    child: Column(
                      children: [
                        _buildMenuItem(
                          ...
                          isActive: currentRoute == '/attendee-dashboard',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          title: 'All Events',
                          route: '/attendee-all-events',
                          isActive: currentRoute == '/attendee-all-events',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          title: 'My Events',
                          route: '/attendee-my-events',
                          isActive: currentRoute == '/attendee-my-events',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          isActive: currentRoute == '/attendee-profile',
                        ),
                      ],
                    ),
                  ),
