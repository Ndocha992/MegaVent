...
class StaffSidebar extends StatelessWidget {
  ...
  const StaffSidebar({super.key, required this.currentRoute});
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildMenuItem(
                          ...
                          title: 'Events',
                          route: '/staff-events',
                          isActive: currentRoute == '/staff-events',
                        ),
                        _buildMenuItem(
                          context: context,
                          icon: Icons.qr_code,
                          ...
                          title: 'QR Code',
                          route: '/staff-scanqr',
                          isActive: currentRoute == '/staff-scanqr',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          title: 'Staff',
                          route: '/staff-staff',
                          isActive: currentRoute == '/staff-staff',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          title: 'Attendees',
                          route: '/staff-attendees',
                          isActive: currentRoute == '/staff-attendees',
                        ),
                        _buildMenuItem(
                          context: context,
                          ...
                          title: 'Profile',
                          route: '/staff-profile',
                          isActive: currentRoute == '/staff-profile',
                        ),
                      ],
                    ),
                  ),
