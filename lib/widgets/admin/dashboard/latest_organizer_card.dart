...
class LatestOrganizerCard extends StatelessWidget {
  final List<Staff> staff;

  const LatestOrganizerCard({super.key, required this.staff});
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text('Latest Organizers', style: AppConstants.headlineSmall),
            TextButton(
              onPressed: () {
                Navigator.of(context).pushReplacementNamed('/admin-organizer');
              },
                  ...
                  : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: () => _onOrganizerTap(context, staffMember),
                        child: ListTile(
                          contentPadding: const EdgeInsets.all(16),
                          leading: OrganizerAvatarWithLoading(staff: staffMember),
                          title: Text(
                          ...
                          trailing: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                'Joined ${StaffUtils.formatHireDate(staffMember.hiredAt)}',
                                style: AppConstants.bodySmall.copyWith(
                                  color: AppConstants.textSecondaryColor,
                                ),
                              ),
  ...
  void _onOrganizerTap(BuildContext context, Staff staff) {
    // Fixed: Ensure complete staff data is passed
    debugPrint('Organizer data being passed: ${staff.toString()}');
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => OrganizerDetails(staff: staff)),
    );
  }
}

class OrganizerAvatarWithLoading extends StatefulWidget {
  final Staff staff;

  const OrganizerAvatarWithLoading({super.key, required this.staff});

  @override
  State<OrganizerAvatarWithLoading> createState() => _OrganizerAvatarWithLoadingState();
}

class _OrganizerAvatarWithLoadingState extends State<OrganizerAvatarWithLoading> {
